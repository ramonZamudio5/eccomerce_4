        ...
        <main class="main-detalles">
            <section class="producto-info-grid">
                ...
                <div class="producto-galeria">
                    <img src="" alt="" class="img-detalle" id="idImagen">
                ...
                <div class="producto-datos">
                    <h1 class="producto-titulo" id = "nombreProducto"></h1>
                    
                    <div class="producto-split">
                        <div class="producto-descripcion" id="descripcion">
                            <p></p>
                        </div>
                        
                        <div class="producto-compra">
                            <h2 class="precio" id="idPrecio"></h2>
                            <p class="disponibilidad" id="idDisponibilidad"></p>
                            ...
                            <p class="stock" id="idStock">Stock: 37</p>
                        </div>
                    </div>
                </div>
            </section>
